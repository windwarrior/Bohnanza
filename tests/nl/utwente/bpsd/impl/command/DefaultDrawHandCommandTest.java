...
public class DefaultDrawHandCommandTest {
    ...
    public void testStandardExecute() throws Exception {
        ...
        assertThat("Game pile size decreased by three", game.getGamePile().pileSize(), is(expectedGamePileSize - DefaultDrawHandCommand.DRAW_HAND_AMOUNT));
        assertThat("Hand pile size increased by three", player.getHand().pileSize(), is(expectedPlayerHandPileSize + DefaultDrawHandCommand.DRAW_HAND_AMOUNT));
        ...
        assertThat("DRAWN_TO_HAND game command result",result, is(DefaultGameCommandResult.DRAWN_TO_HAND));
    }
    ...
    public void testEdgeCaseExecute() throws Exception {
        while(game.getGamePile().pileSize() >= DefaultDrawHandCommand.DRAW_HAND_AMOUNT) {
